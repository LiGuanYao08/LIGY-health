...
public final class MessageConstant {
    ...
    public static final String QUERY_MAP_SUCCESS = "查询地图数据成功";
    public static final String QUERY_MAP_FAIL = "查询地图数据失败";
    ...
    public static final String QUERY_ORDERSETTINGLIST_SUCCESS = "查询预约列表成功";
    public static final String QUERY_ORDERSETTINGLIST_FAIL = "查询预约列表失败";
    ...
    public static final String  ADD_ILLKONW_SUCCESS = "新建疾病库成功";
    public static final String  ADD_ILLKONW_FAIL = "新建疾病库失败";
    public static final String  EDIT_ILLKONW_SUCCESS = "修改疾病库成功";
    public static final String  EDIT_ILLKONW_FAIL = "修改疾病库失败";
    public static final String  DELETE_ILLKONW_SUCCESS = "删除疾病库成功";
    public static final String  DELETE_ILLKONW_FAIL = "删除疾病库失败";
    public static final String  FIND_ILLKONW_SUCCESS = "查询疾病库成功";
    public static final String  FIND_ILLKONW_FAIL = "查询疾病库失败";

    public static final String  UPDATE_USER_SUCCESS = "更新套餐成功";
    public static final String  UPDATE_USER_FAIL = "更新套餐失败";

    public static final String  DELETE_USER_SUCCESS = "删除会员档案成功";
    public static final String  DELETE_USER_FAIL = "删除会员档案失败";

    public static final String  DELETE_PERMISSION_SUCCESS = "删除权限成功";
    public static final String  DELETE_PERMISSION_FAIL = "删除权限失败";


    public static final String  QUERY_USER_SUCCESS = "更新会员成功";
    public static final String  QUERY_USER_FAIL = "更新会员失败";

    public static final String  FIND_PERMISSION_SUCCESS = "查询权限成功";
    public static final String  FIND_PERMISSION_FAIL = "查询权限失败";
        }