...
public class Order implements Serializable{
    ...
    private Integer addressId;//预约地址id
    public Order() {
    }


    public Order(Integer id, Integer memberId, Date orderDate, String orderType, String orderStatus, Integer setmealId, Integer addressId) {
        this.id = id;
